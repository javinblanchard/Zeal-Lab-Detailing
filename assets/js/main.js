...
function mainNav() {
  ...
  // ================================
  // ✅ CLOSE MENU AFTER LINK CLICK (NEW)
  // ================================
  $(".ak-nav_list a[href^='#']").on("click", function () {
    // Only close on mobile-sized screens
